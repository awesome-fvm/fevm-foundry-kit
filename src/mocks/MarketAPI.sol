...
contract MarketAPI {
    ...
    function add_balance(MarketTypes.AddBalanceParams memory params)
        public
        payable
    {
    ...
    function get_balance(string memory addr)
        public
        view
    ...
    function get_deal_client(MarketTypes.GetDealClientParams memory params)
        public
        view
        returns (MarketTypes.GetDealClientReturn memory)
    {
        require(deals[params.id].id > 0);
    ...
    function get_deal_label(MarketTypes.GetDealLabelParams memory params)
        public
        view
    ...
    function get_deal_term(MarketTypes.GetDealTermParams memory params)
        public
        view
    ...
    function publish_storage_deals(bytes memory raw_auth_params, address callee)
        public
    {
